...
stage : rel
	$(foreach dep,$(wildcard deps/* wildcard apps/*), rm -rf rel/philtre/lib/$(shell basename $(dep))-* && ln -sf $(abspath $(dep)) rel/philtre/lib;)
...
COMBO_PLT = $(HOME)/.philtre_combo_dialyzer_plt
